...
function TommorowPrepration() {
  ...
  const handleCreatePrompt = () => {
    const initialData = `I am a trader using the strategy of CPR and Pivot points with moving Average.
        I use the Central pivot Range(CPR) for the trade and trend analysis. So Tommorow I going to take a Stock
  ...
  const widthOfCPR = [
    {
      id: 'CPR is Narrow',
      value: 'The width of the CPR is Narrow'
    },
    {
      id: 'CPR is Wide',
      value: 'The width of the CPR is Wide'
    },
    {
      id: 'Too Narrow',
    ...
    {
      id: 'Too Wide',
      value: 'The width of the CPR is too Wide compared to last few days'
    }
  ];
      ...
      <Grid spacing={0} container>
        <Grid item xs={12} md={6}>
          <Box p={4}>
            ...
            <TextField
              label="Brief Overview About Yesterday"
              variant="outlined"
              fullWidth={true}
              margin="normal"
              multiline={true}
...
export default TommorowPrepration;
